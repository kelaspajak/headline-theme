...
sort: 18
category: "Lain-Lain"
description: "Kumpulan FAQ Solusi Error dari Coretaxpedia"
...
3. Lengkapi isian kemudian klik tombol **Submit**dan terbitkan. 
...
6. Klik tombol **Bayar dan Lapor**untuk membentuk kode billing atau melakukan pembayaran menggunakan saldo deposit. 
...
Apabila Anda sudah memiliki akun DJP Online atau sudah pernah aktivasi akun sebelumnya, maka Anda dapat mengakses Coretax DJP melalui pengaturan ulang kata sandi. Ikuti petunjuk [pada artikel ini](https://pajak.go.id/coretaxpedia/atur-ulang-kata-sandi). 

Apabila Anda lupa nomor HP yang terdaftar, Anda dapat mengakses Coretax DJP melalui menu aktivasi. Ikuti petunjuk [pada artikel ini](https://pajak.go.id/coretaxpedia/aktivasi-akun-dengan-perubahan-detail-kontak).
...
Apabila Anda **sudah**pernah memiliki akun DJP Online, lakukan aktivasi akun Coretax DJP dengan mengikuti langkah-langkah [pada artikel ini](https://pajak.go.id/coretaxpedia/akses-coretax-bagi-user-djp-online). 

Apabila Anda **belum**memiliki akun DJP Online, lakukan aktivasi akun Coretax DJP dengan mengikuti langkah-langkah [pada artikel ini](https://pajak.go.id/coretaxpedia/akses-coretax-bagi-bukan-user-djp-online).
...
- [Aktivasi akun dengan perubahan detail kontak](https://pajak.go.id/coretaxpedia/aktivasi-akun-dengan-perubahan-detail-kontak)
...
> **Saya melakukan penambahan data anak, tetapi muncul *error* penambahan alamat. Masalahnya pada form tidak ada**field**alamat yang harus diisikan. Bagaimana solusi atas kendala ini?**
...
Pastikan Anda telah mengunduh versi terbaru konverter dan memastikan file XML Anda benar serta langsung mengunggahnya tanpa menekan tombol "lihat konsep retur". Versi terbaru konverter dapat [diunduh di sini](https://www.pajak.go.id/reformdjp/coretax/template-xml-dan-converter-excel-ke-xml).
